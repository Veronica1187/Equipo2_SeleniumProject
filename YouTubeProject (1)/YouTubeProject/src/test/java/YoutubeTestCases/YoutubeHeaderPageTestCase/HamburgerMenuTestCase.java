...
public class HamburgerMenuTestCase extends BaseTestCase {
    ...
    public static void trendingValidation(){
    ...
    public static void subscriptionValidation(){
    ...
    public static void libraryValidation(){
    ...
    public static void historyValidation(){
